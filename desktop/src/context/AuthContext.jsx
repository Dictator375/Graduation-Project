...
const ar = {
  ...
  invoices:'الفواتير', institutions:'المؤسسات', messages:'الرسائل', suppliers:'الموردون',
  payroll:'الرواتب والحضور', settings:'الإعدادات',
  ...
  payrollReport:'تقرير الرواتب', generatePayroll:'حساب الرواتب', baseSalary:'الراتب الأساسي',
  dailyRate:'الأجر اليومي', daysWorked:'أيام العمل', daysAbsent:'أيام الغياب',
  deductionLabel:'الخصم', netSalary:'الصافي', prorated:'نسبي',
  attendanceReport:'تقرير الحضور', estimatedSalary:'الراتب المتوقع',
  attendanceSummary:'ملخص الحضور', payrollGenerated:'تم حساب الرواتب',
  noPayrollYet:'لم يتم حساب الرواتب بعد', generateFirst:'اضغط على "حساب الرواتب" لبدء الحساب',
  totalDeductions:'إجمالي الخصومات', totalNetPay:'إجمالي الصافي', workerCount:'عدد العمال',
  workerDetail:'تفاصيل العامل', monthLabel:'الشهر', daysTotal:'إجمالي الأيام',
  ...
  addSupplier: 'إضافة مورد', supplierName: 'اسم المورد', contactPerson: 'اسم جهة الاتصال',
  email: 'البريد الإلكتروني', address: 'العنوان', selectSupplier: 'اختر المورد',
};
...
const fr = {
  ...
  invoices:'Factures', institutions:'Institutions', messages:'Messages', suppliers:'Fournisseurs',
  payroll:'Paie & Présence', settings:'Paramètres',
  ...
  payrollReport:'Rapport de paie', generatePayroll:'Calculer la paie', baseSalary:'Salaire de base',
  dailyRate:'Taux journalier', daysWorked:'Jours travaillés', daysAbsent:'Jours absents',
  deductionLabel:'Déduction', netSalary:'Salaire net', prorated:'Proratisé',
  attendanceReport:'Rapport de présence', estimatedSalary:'Salaire estimé',
  attendanceSummary:'Résumé de présence', payrollGenerated:'Paie calculée',
  noPayrollYet:'Pas encore de paie calculée', generateFirst:'Cliquez sur "Calculer la paie" pour commencer',
  totalDeductions:'Total déductions', totalNetPay:'Total net', workerCount:'Nombre d\'employés',
  workerDetail:'Détails de l\'employé', monthLabel:'Mois', daysTotal:'Total jours',
  ...
  addSupplier: 'Ajouter fournisseur', supplierName: 'Nom du fournisseur', contactPerson: 'Contact',
  email: 'Email', address: 'Adresse', selectSupplier: 'Sélectionner fournisseur',
};
